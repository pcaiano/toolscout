...
export function decoratePublicAnalytics(request,html){
  ...
  if(choice==='granted'&&!value.includes('googletagmanager.com/gtag/js'))value=value.replace(/<\/head>/i,`${analyticsTags()}</head>`);
