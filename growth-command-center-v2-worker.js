...
'<div class="row" style="margin-top:10px"><div><div class="rowName">Alternate distribution routes</div><div class="rowMeta">Public contact or amplification routes discovered across '+n(x.contact_route_surfaces)+' external surfaces. These are opportunities to pursue, not external proof.</div></div><div class="value">'+n(x.contact_routes)+'</div></div>'+
