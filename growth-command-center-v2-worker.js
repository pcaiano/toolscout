...
'<div class="row"><div><div class="rowName">Growth loop integrity</div><div class="rowMeta">'+esc(String(x.loop_status||'unknown').toUpperCase())+' · '+n(x.loop_orphan_routes)+' orphan routes · '+n(x.loop_stale_route_actions)+' stalled route actions · '+n(x.loop_stale_growth_actions)+' stale actions · '+n(x.loop_failed_core_runs_24h)+' failed core runs</div></div><div class="value">'+esc(String(x.loop_status||'unknown'))+'</div></div>'+
