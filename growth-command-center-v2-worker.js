...
function renderBusinessPulse(d){
 ...
 const x=d?.growthOps?.autonomousGrowth||{},foot=d?.growthOps?.footprint?.search||{},t=d?.traffic||{},f=d?.funnel||{},commercial=d?.commercial||{},rev=d?.revenue||{},q=d?.growthOps?.chairmanQueue||{},dist=d?.growthOps?.engines?.distribution||{};
 ...
 const refs=Number(x.verified_referring_domains||0),floor=Number(x.backlink_bootstrap_floor||10),attempts=Number(x.backlink_attempts_24h||0),attemptMin=Number(x.backlink_attempt_min_24h||6),impressions=Number(foot.impressions||0),clicks=Number(foot.clicks||0);
 ...
 '<div class="row"><div><div class="rowName">Search evidence</div><div class="rowMeta">'+esc(foot.source||'GSC')+' · '+n(foot.observed_pages)+' visible pages</div></div><div class="rowValue">'+esc(dt(foot.generated_at))+'</div></div>'+
