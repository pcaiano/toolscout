...
'<div class="row" style="margin-top:10px"><div><div class="rowName">Growth loop health</div><div class="rowMeta">'+esc(String(x.loop_status||'unknown').toUpperCase())+' · '+n(x.loop_orphan_routes)+' orphan routes · '+n(x.loop_stale_route_actions)+' stalled route actions · '+n(x.loop_stale_growth_actions)+' stale actions · '+n(x.loop_failed_core_runs_24h)+' failed core runs · effectiveness '+esc(String(x.effectiveness_status||'unknown'))+' ('+n(x.matured_growth_actions)+' mature actions → '+n(x.matured_attributed_human_sessions)+' strict humans)</div></div><div class="value">'+esc(String(x.loop_status||'unknown'))+'</div></div>'+
