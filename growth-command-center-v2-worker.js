...
metric('URL Inspection',n(idx.indexed)+' / '+n(idx.inspected)+' pass',n(idx.notIndexed)+' index issues · '+n(idx.errors)+' API errors')+
metric('Inspection coverage',Number(idx.inspectionCoveragePct||0).toFixed(1)+'%',n(idx.inspectionUniverseUrls)+' discovered URLs')+
metric('Canonical mismatches',n(idx.canonicalMismatches),n(idx.fetchIssues)+' fetch issues · '+n(idx.robotsBlocked)+' robots blocks')+
