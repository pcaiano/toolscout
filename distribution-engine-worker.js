...
async function distributionSnapshot(request,env){
  const [config,workflow,opportunities,events,embeds,referrals]=await Promise.all([
  ...
  return {
    ...
    opportunities:configured.length,activeSurfaces:active,humanRequired:humanRequired.length,
...
function injectDistribution(html){
  ...
  const section=`<section class="section" id="distributionEngineSection"><div class="sectionHead"><h2>Distribution Engine</h2><span>Global · automation-first</span></div><div class="grid4" id="distributionMetrics"></div><div class="grid2 section"><div class="panel"><div class="sectionHead"><h2>Priority surfaces</h2><span>Distribution Score</span></div><div id="distributionSurfaces" class="note">Refresh to load.</div></div><div class="panel"><div class="sectionHead"><h2>Human Required</h2><span>Exception queue</span></div><div id="distributionHuman" class="note">Refresh to load.</div></div></div><div class="grid2 section"><div class="panel"><div class="sectionHead"><h2>Embedded distribution</h2><span>Finder · Compare · Pick</span></div><div id="distributionEmbeds" class="note">Refresh to load.</div></div><div class="panel"><div class="sectionHead"><h2>Recent activity</h2><span>What the engine did</span></div><div id="distributionActivity" class="note">Refresh to load.</div></div></div></section>`;
