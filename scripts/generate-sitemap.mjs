...
const publicUrl=file=>`${BASE}/${cleanFile(file)}`;
...
for(const file of files)urls.push(publicUrl(file));
...
for(const file of blogFiles)urls.push(`${BASE}/blog/${cleanFile(file)}`);
