...
const CORE_PAGES=['guides.html','tools.html','compare.html','methodology.html','affiliate-disclosure.html','privacy.html','categories.html','crm-tools.html','seo-tools.html','software-trends-index.html'];
...
console.log(JSON.stringify({urls:finalUrls.length,intentAndComparisonPages:files.length,indexableBlogPages:blogFiles.length,blogIndexIncluded:finalUrls.includes(`${BASE}/blog/`),softwareTrendsIndexIncluded:finalUrls.includes(`${BASE}/software-trends-index`)}));
