...
console.log(JSON.stringify({urls:unique.length,intentAndComparisonPages:files.length,indexableBlogPages:blogFiles.length,blogIndexIncluded:urls.includes(`${BASE}/blog/`)}));
