...
let updated=0,skipped=0,existing=0,upgraded=0,injected=0,cleanedUrls=0,removedBrokenLinks=0;
...
console.log(JSON.stringify({updated,skipped,existing,upgraded,injected,cleanedUrls,removedBrokenLinks}));
