...
console.log(JSON.stringify({guides:guideItems.length,rssItems:rssItems.length,categories:byCategory.size,feed:FEED_URL,tracking:{utm_source:'toolscout_rss',utm_medium:'distribution',utm_campaign:'syndication'}}));
