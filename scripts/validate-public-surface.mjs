...
console.log(`Public-surface validation passed: ${guideFiles.length} guides, ${comparisonFiles.length} comparisons, ${toolFiles.length} tool profiles and ${blogFiles.length} blog files checked.`);
