...
function cordialOutreach(row){
  ...
  const profile=taggedOwned(`https://trytoolscout.org/tools/${encodeURIComponent(slug)}.html`,{source:'vendor_outreach',campaign:'vendor_reference_v22',action,growth});
