...
export const SOCIAL_PLATFORM_CAPABILITIES=Object.freeze({
  ...
  threads:Object.freeze({publish:true,inbound_monitor:true,reply_write:true,reaction_write:false,attribution:true,audience_mode:'autonomous_reply',mentions_read:true,keyword_search:true,insights:true})
});
